...
function oyCrosswordClue(
	wordid,		//Word ID of WordNet Database. Id of All synsets are same.
	synsetid,	//synsetid of WordNet Database which is only unique identifier of a word.
