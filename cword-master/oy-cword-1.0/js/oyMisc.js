...
//Show Total Time in Footer (Lower Right Section) that needed for Puzzle Execution
oyCrosswordFooter.prototype.clockUpdate = function(){	
	...
	if (this.puzz.started){
		...
		document.getElementById("oygFooterClock").innerHTML = "&nbsp;Time: <b>" + pad(min) + "</b>:<b>" + pad(sec) +"</b>"; // Total Time 
	}
} 
